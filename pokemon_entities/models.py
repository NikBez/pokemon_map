...
class Pokemon(models.Model):
    ...
    title_en = models.CharField("Название (Английский)", max_length=200)
    title_jp = models.CharField("Назвагие (Японский)", max_length=200 )
...
class PokemonEntity(models.Model):
    ...
    append_at = models.DateTimeField( "Время появления", blank=True, null=True)
